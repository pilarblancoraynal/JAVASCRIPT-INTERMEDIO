...
function datiStudente(studente) {
	report += '<h2>Studente: ' + studente.nome + '</h2>';
...
while(true) {
	ricerca = prompt("Cerca uno studente.Inserisci il nome per visualizzare il profilo, scrivi -esci- per chiudere il programma");
